...
mkdir BID_2.0.1
cd BID_2.0.1
wget https://github.com/IDCHAINGROUP/BID/releases/download/v2.0.1/bid-2.0.1-ubuntu-daemon.tar.gz
tar -xzvf bid-2.0.1-ubuntu-daemon.tar.gz
...
cd ~/.blockidcoin/
wget https://github.com/IDCHAINGROUP/BID/releases/download/v2.0.1/bootstrap.zip
unzip bootstrap.zip
